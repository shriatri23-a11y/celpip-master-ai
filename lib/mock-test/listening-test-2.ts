...
const steps: TestStep[] = [
  ...
  },
  {
    ...
    kind: "audio",
    headerTitle: `${HEADER_BASE} Part 3: Listening for Information`,
    instruction: "Listen to the talk. You will hear it only once. It is about 60 seconds long.",
    blueprint: LISTENING_BLUEPRINT.travelAnnouncement,
    script: [
      { speaker: "Guide", text: "Welcome, everyone, to the Riverside Nature Reserve. Before we set off on our walk, I'd like to go over a few important reminders. Our main loop trail is four kilometres long and takes about ninety minutes at an easy, relaxed pace, so there's no need to rush." },
      { speaker: "Guide", text: "Please stay on the marked gravel paths at all times. This is especially important right now, because several species of birds are nesting very close to the trail, and wandering off can disturb them. If you'd like a closer look at the wildlife, we lend out binoculars at the visitor centre — there's just a small deposit, which you get back when you return them. Photography is very welcome, but please switch off your flash whenever you're near the wetlands, as it startles the animals. Our guided walks leave every hour, on the hour, until four o'clock in the afternoon, and the very last entry to the reserve is at four thirty." },
    ],
    transcript:
      "A guide introduces the Riverside Nature Reserve: a 4 km main loop taking about 90 minutes at an easy pace. Visitors must stay on the marked gravel paths because birds are nesting close to the trail. Binoculars can be borrowed from the visitor centre for a small refundable deposit. Flash photography is banned near the wetlands. Guided walks leave hourly until 4 p.m., and the last entry is at 4:30.",
  },
  q("p3q1", `${HEADER_BASE} Part 3: Listening for Information`,
    "How long is the main loop trail?",
    ["One kilometre.", "Two kilometres.", "Three kilometres.", "Four kilometres."], 3),
  q("p3q2", `${HEADER_BASE} Part 3: Listening for Information`,
    "Why must visitors stay on the marked paths?",
    ["To avoid getting lost.", "Because birds are nesting nearby.", "Because the ground is muddy.", "To protect rare plants."], 1),
  q("p3q3", `${HEADER_BASE} Part 3: Listening for Information`,
    "How can visitors get binoculars?",
    ["By leaving a small refundable deposit at the visitor centre.", "By buying them at the gate.", "They must bring their own.", "They are given free to everyone."], 0),
  q("p3q4", `${HEADER_BASE} Part 3: Listening for Information`,
    "What photography rule applies near the wetlands?",
    ["No photos are allowed at all.", "Only staff may take photos.", "Flash must be switched off.", "A permit is required."], 2),
  q("p3q5", `${HEADER_BASE} Part 3: Listening for Information`,
    "When is the last entry to the reserve?",
    ["Three o'clock.", "Four o'clock.", "Four fifteen.", "Four thirty."], 3),
  ...
  },
  {
    ...
    script: [
      { speaker: "Reporter", text: "In city news this evening, officials have confirmed that the downtown public library will undergo a major renovation, with work scheduled to begin this fall. The project is expected to last about six months. When it's finished, the library will feature a brand-new children's learning centre, significantly expanded study and reading areas, and energy-efficient lighting installed throughout the building to cut long-term costs." },
      { speaker: "Reporter", text: "During the construction period, the library's services won't stop. Instead, they'll move to a temporary space in the community centre on Elm Street, where members can still borrow books, use computers, and attend the library's popular reading programs. Officials also want to reassure residents on two points. First, any borrowed books can be returned to any branch across the city, not just the downtown location. And second, all late fees will be suspended until the main branch reopens, which is currently expected in the spring. The head librarian said the aim is to turn the aging building into a modern community hub, and she thanked residents in advance for their patience." },
    ],
    transcript:
      "Officials confirmed a six-month renovation of the downtown public library starting in the fall, adding a children's learning centre, expanded study areas, and energy-efficient lighting. Services move temporarily to the Elm Street community centre, where members can still borrow books, use computers, and join reading programs. Borrowed books may be returned to any branch, and late fees are suspended until the main branch reopens in spring. The head librarian described the goal as creating a modern community hub.",
  },
  q("p4q1", `${HEADER_BASE} Part 4: Listening to a News Item`,
    "What is the news item mainly about?",
    ["A new library opening.", "A permanent branch closure.", "A downtown library renovation.", "A book-donation drive."], 2),
  q("p4q2", `${HEADER_BASE} Part 4: Listening to a News Item`,
    "How long is the project expected to take?",
    ["Three months.", "About six months.", "One year.", "Two years."], 1),
  q("p4q3", `${HEADER_BASE} Part 4: Listening to a News Item`,
    "What will be added for children?",
    ["A playground.", "A daycare.", "A cafe.", "A learning centre."], 3),
  ...
  q("p4q5", `${HEADER_BASE} Part 4: Listening to a News Item`,
    "What will happen to late fees during the renovation?",
    ["They will double.", "They apply only downtown.", "They will be suspended until reopening.", "They stay the same."], 2),
